...
<body>
  ...
  <div class="container">
      ...
      <div class="right_wrap">
        ...
        <form action="<?php echo U('noticeAdd');?>" method="post" class="">
        <table>
          <tfoot>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>
                <input type="submit" name="input" value="发布"></td>
              <td>&nbsp;</td>
            </tr>
          </tfoot>
          <tbody>
        ...
        <?php endif;?>
         <?php if($userRole==4 && userId): ?>
          <tr>
            <td>&nbsp;</td>
            <td>可见部门：</td>
            <td>
              <select name="scan" id="scan">
              <option selected="true" value="4">财务部</option>
              <option value="5">管理层</option>
              </select></td>
              <td>&nbsp;</td>
          </tr>
